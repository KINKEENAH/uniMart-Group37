...
export default function ProductDetails() {
    ...
    return (
      <div className="min-h-screen bg-[#F5F0E8] pt-16 flex flex-col items-center justify-center gap-4">
        ...
        <button
          ...
          className="text-[#F5A623] underline text-sm cursor-pointer"
        >
          Back to Shop
        </button>
      </div>
  ...
  const originalPrice = (product || display).original_price
    ? parseFloat((product || display).original_price)
    : null;
  const discount =
